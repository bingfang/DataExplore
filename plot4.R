...
#Fig 4
par(mfcol = c(2, 2))
plot(hhp$Date_Time, hhp$Global_active_power, type = "l", xlab = "", ylab = "Global active power")
...
plot(hhp$Date_Time, hhp$Voltage, type = "l", xlab = "datetime", ylab = "Voltage")

plot(hhp$Date_Time, hhp$Global_reactive_power, type = "l", xlab = "datetime", ylab = "Global Reactive Power")
